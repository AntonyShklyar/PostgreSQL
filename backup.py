...
def main():
		...
		#Counting the time it takes to complete a backup operation.The execution time is stored in a variable "TIME"
                ...
                if process==0:
                    with open("/var/log/backupdb.log","a+") as stdout: 
                        ...
                        b=subprocess.Popen('echo backupdb-$(uname -n)-$(date +"%Y%m%d-%H%M%S").tar.gz', shell=True, stdout=subprocess.PIPE); copy = subprocess.check_output(('xargs', 'echo'),stdin=b.stdout).decode("utf-8")
                        copy=copy.split("\n")[0]; b.wait() 
    ...
    codname={'OCOD':['10.111.15.54', '10.111.16.54', '10.111.17.54'], 'RCOD':['10.111.15.63', '10.111.16.63', '10.111.17.63'], 'GCOD':['10.111.15.54', '10.111.16.54', '10.111.17.54']}
